...
public class DelSeriesPageController {
    ...
    void initialize() throws UnavailableDB {
        ...
        delButton.setOnAction(actionEvent -> {
            ...
            try {
                Integer seriesId = Integer.parseInt(idTextField.getText());

                try {
                    dbManager.delSeries(seriesId);
                ...
                informationField.setText("Select the series_id you want to delete");
